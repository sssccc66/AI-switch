...
// 构造函数
// ============================================================
openai_compatible_adapter::openai_compatible_adapter(const std::string& api_key,
    ...
    , model_prefix_(std::move(model_prefix))
    , provider_name_(std::move(provider_name))
{
    std::cout << "[" << provider_name_ << "] 已初始化, base_url=" << base_url_ << "\n";
}

// ============================================================
// build_request_body — 根据请求体和 stream 标志组装符合 OpenAI 协议的请求 JSON
// ============================================================
nlohmann::json openai_compatible_adapter::build_request_body(
...
// ============================================================
nlohmann::json openai_compatible_adapter::chat_completion(const nlohmann::json& request) {
    // 组装请求体
    ...
    try {
        ...
        std::cerr << "[" << provider_name_ << "] JSON 解析失败: " << e.what() << "\n";
        return {
            {"error", {
                {"code", "parse_error"},
...
// ============================================================
void openai_compatible_adapter::chat_completion_stream(
...
// ============================================================
std::string openai_compatible_adapter::http_post(const std::string& url,
...
// http_post — 非流式 HTTP POST
// ============================================================
void openai_compatible_adapter::http_post_stream(
